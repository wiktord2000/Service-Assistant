...
import { CustomHeaderModule } from '../../../shared/components/custom-header/custom-header.module';
import { ServiceSelectInputModule } from '../../../shared/components/selectors/service-select-input/service-select-input.module';
import { FormsModule, ReactiveFormsModule } from '@angular/forms';
import { MatSlideToggleModule } from '@angular/material/slide-toggle';
import { MatFormFieldModule } from '@angular/material/form-field';
import { MatIconModule } from '@angular/material/icon';
import { MatButtonModule } from '@angular/material/button';
import { ProductSelectInputModule } from '../../../shared/components/selectors/product-select-input/product-select-input.module';
...
import { VehicleSelectInputModule } from '../../../shared/components/selectors/vehicle-select-input/vehicle-select-input.module';
